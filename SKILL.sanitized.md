...
- **Reviewer** - 负责技术选型审查和指令生成
- **Executor** - 负责代码执行和文件操作
- **Auditor** - 负责质量审核和验证

**注意：** 你可以用任何支持的工具实现这些角色。
...
| **Executor** | 默认代码模型 | 默认代码模型 | 默认代码模型 |
| **Reviewer** | - | 默认审阅模型 | 高级模型 |
| **Auditor** | - | 默认审核模型 | 高级模型 |
| **耗时** | ~5m | ~15m | ~15m |
| **成本** | 🆓 | 🆓 | 💰$$ |
| **成功率** | ~80% | ~90% | ~95% |
